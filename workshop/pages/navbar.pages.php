    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item pt-2">
                    <a class="sidebar-link waves-effect waves-dark sidebar-link" href="add-assessment.php" aria-expanded="false">
                        <i class="fas fa-book" aria-hidden="true"></i>
                        <span class="hide-menu">Add Assessment</span>
                    </a>
                </li>
                ...
                <li class="sidebar-item pt-2">
                    <a class="sidebar-link waves-effect waves-dark sidebar-link" href="manage-assessments.php" aria-expanded="false">
                        ...
                        <span class="hide-menu">Manage Assessment</span>
                    </a>
                </li>
