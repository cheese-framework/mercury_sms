...
<div class="container-scroller">
    ...
    <div class="main-panel">
        <div class="content-wrapper pb-0">
            <h1 class="text-center">You are seeing this page because you are not fully activated.</h1>
            <blockquote class="blockquote">
                <i>If you are seeing this after a year of subscription, it means you have to
                    renew your
                    subscription plan in
                    order to continue using these services. Your data will be safe and handed back to you after renewal.
                    Thank you!.</i>
            </blockquote>
