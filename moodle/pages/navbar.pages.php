        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link waves-effect waves-dark sidebar-link" href="manage-subjects.php" aria-expanded="false">
                ...
                if (Helper::isUsingOnlineAssessment($schoolId)) : ?>
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link waves-effect waves-dark sidebar-link" href="manage-assessments.php" aria-expanded="false">
                            <i class="fa fa-book fas-2" aria-hidden="true"></i>
                            <span class="hide-menu">Manage Assessments</span>
                        </a>
                    </li>
                <?php endif; ?>
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link waves-effect waves-dark sidebar-link" href="?logout=true" aria-expanded="false">
